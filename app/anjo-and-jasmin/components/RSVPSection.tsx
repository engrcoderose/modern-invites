...
const fieldClass =
  "mt-2 w-full rounded-xl border border-[#dfcfd4] bg-[#fffdfa] px-4 py-3 text-base font-normal normal-case tracking-normal text-[#624451] transition-colors placeholder:text-[#a28b95] focus:border-[#946879] focus:outline-none focus:ring-2 focus:ring-[#946879]/20";
...
export default function RSVPSection({ deadline }: RSVPSectionProps) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-t border-[#ead7df] bg-[#f5e9ed] bg-[radial-gradient(ellipse_at_top_left,#fff9f4,transparent_65%)] px-5 py-20 text-[#624451] sm:px-8 sm:py-28 lg:px-12 lg:py-32"
    >
      <FloralAccent
        kind="blue"
      ...
      <div className="relative mx-auto max-w-6xl">
        <Reveal className="mx-auto mb-10 max-w-3xl text-center sm:mb-14">
          ...
          >
            Will you{" "}
            <span className="font-meaCulpa font-normal text-[#946879]">
              join us?
            </span>
          </h2>
        </Reveal>
              ...
              <div className="flex flex-1 flex-col justify-center px-6 py-8 text-center sm:px-10 sm:py-10 lg:text-left">
                ...
                <div className="mt-7 flex items-start gap-3 border-t border-[#d8b9c7]/60 pt-6 text-left">
                  <Mail
                    ...
                    strokeWidth={1.4}
                    aria-hidden="true"
                    className="mt-1 shrink-0 text-[#946879]"
                  />
            ...
            <div className="min-w-0 px-6 py-8 sm:p-10 lg:p-12">
              {preview ? (
                <div className="flex min-h-[32rem] flex-col items-center justify-center text-center">
                  <div className="grid h-12 w-12 place-items-center text-[#637b65]">
                  ...
                  <p
                    role="status"
                    className="mt-5 max-w-sm text-base leading-8 text-[#756770] lg:text-lg"
                  >
                    Thank you, {response.firstName}. This is a preview only.
                    Your reply has not been sent or saved.
                  </p>
                  <p className="mt-4 text-sm leading-7 text-[#876675] lg:text-base">
                  ...
                  <button
                    ...
                    className="mt-8 min-h-11 rounded-full border border-[#cba4b6] px-6 py-3 text-sm text-[#876675] transition-colors hover:bg-[#f8eff0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#946879]"
                  >
                    Edit preview
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="pb-2">
                    ...
                    <p className="mt-3 text-sm leading-6 text-[#876675]">
                      RSVP preview Â· Replies are not sent or saved yet.
                    </p>
                  </div>
                      ...
                      {[
                        ...
                        >
                          <input
                            ...
                            name="attending"
                            value={answer.value}
                            checked={response.attending === answer.value}
                            onChange={(e) =>
                              setResponse({
                                ...response,
                            ...
                            className="h-4 w-4 shrink-0 accent-[#718463]"
                          />
                          {answer.label}
                        </label>
                      ))}
                  ...
                  <label className={labelClass}>
                    ...
                    <span className="font-normal text-[#876675]">
                      (optional)
                    </span>
                    <textarea
                      name="message"
                      ...
                      placeholder="A wish, a song, or something we should knowâ€¦"
                    />
                  </label>
                  <button
                    type="submit"
                    className="group flex min-h-14 w-full items-center justify-center gap-3 rounded-full bg-[#946879] px-6 py-4 text-sm font-medium text-[#fffaf3] transition-colors hover:bg-[#7e5666] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#946879] sm:text-base"
                  >
                    Preview my response
                    <ArrowRight
                      size={18}
