...
const slides: HeroSlide[] = [
  { src: Walking, alt: "Joshua and Bea walking hand in hand in the garden", position: "50% 45%", mobilePosition: "50% 45%" },
  { src: Together, alt: "Joshua and Bea leaning together on a garden bench", position: "50% 48%", mobilePosition: "50% 48%" },
  { src: Garden, alt: "Joshua and Bea sharing a playful moment in the garden", position: "50% 48%", mobilePosition: "50% 48%" },
  { src: Sitting, alt: "Joshua and Bea sitting together among the greenery", position: "50% 45%", mobilePosition: "50% 45%" },
  { src: Embrace, alt: "Joshua and Bea embracing in the garden", position: "50% 48%", mobilePosition: "82% 48%" },
];
...
export default function HeroSection({ bride, groom, dateDisplay, location }: HeroSectionProps) {
  ...
  return (
    <section
      id="top"
      ref={hero}
      aria-label="Joshua and Bea wedding photo slideshow"
      aria-roledescription="carousel"
      className="garden-hero h-svh min-h-[680px] [@media(max-width:600px)]:min-h-[700px] [@media(max-height:500px)_and_(min-width:601px)]:min-h-[520px] relative isolate overflow-hidden bg-[#263d35] text-[#ffe1ee]"
      data-opened={opened}
    ...
    >
        ...
        {slides.map((slide, index) => (
          ...
          >
            <Image
              ...
              quality={85}
              sizes="100vw"
              className="garden-hero-photo object-cover [object-position:var(--photo-position)] [@media(max-width:600px)]:[object-position:var(--phone-photo-position)]"
      ...
      <div className="pt-[clamp(110px,14svh,180px)] [text-shadow:0_1px_8px_#263d3530] [@media(max-width:600px)]:h-full [@media(max-width:600px)]:justify-center [@media(max-width:600px)]:px-6 [@media(max-width:600px)]:pt-[72px] [@media(max-width:600px)]:pb-[120px] [@media(max-height:500px)_and_(min-width:601px)]:pt-[75px] relative z-10 flex flex-col items-center px-6 text-center">
        <div className="garden-hero-reveal relative flex flex-col items-center [@media(max-width:600px)]:-top-3">
        ...
        <h1 className="garden-hero-names garden-hero-reveal [@media(max-width:600px)]:flex-col [@media(max-width:600px)]:items-center [@media(max-width:600px)]:gap-[.25em] [@media(max-width:600px)]:my-6 [@media(max-width:600px)]:text-[clamp(72px,18vw,100px)] [@media(max-width:600px)]:leading-[1.05] [@media(max-height:500px)_and_(min-width:601px)]:text-[110px] [@media(max-height:500px)_and_(min-width:601px)]:my-3 my-6 flex items-baseline justify-center gap-[.16em] whitespace-nowrap [font-family:var(--font-mea-culpa),cursive] text-[clamp(80px,12.5vw,185px)] font-normal not-italic leading-[1.1] sm:my-8" aria-label={`${groom} and ${bride}`}>
          <span>{groom}</span><span className="text-[.8em] [@media(max-width:600px)]:text-[.55em] [@media(max-width:600px)]:leading-[.9]">&amp;</span><span>{bride}</span>
        </h1>
      ...
      <div className="h-[48%] [@media(max-width:600px)]:w-[850px] [@media(max-width:600px)]:h-[32%] [@media(max-width:600px)]:left-1/2 [@media(max-width:600px)]:right-auto [@media(max-width:600px)]:-translate-x-1/2 pointer-events-none absolute inset-x-0 bottom-0 z-[5] opacity-[.65]" aria-hidden="true">
