...
export default function PricingPreview() {
  return (
    <section
      id="packages"
      className="scroll-mt-24 bg-ivory px-4 py-24 sm:px-6 lg:px-8 lg:py-32"
    >
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          ...
          title={
            <>
              A beautiful beginning at{" "}
              <span className="italic text-eucalyptus-dark">₱799.</span>
            </>
          }
        ...
        <ScrollReveal delay={0.12}>
          <div className="mt-9 flex flex-col items-center justify-center gap-3 text-center sm:flex-row">
            ...
            <Link
              href="/pricing"
              className="group inline-flex items-center gap-2 text-sm font-bold text-forest"
            >
