# Anjo & Jasmin — Signature wedding sample

Route: `/jasmin-and-anjo-wedding`. The previous `/jasmin-and-anjo` URL permanently redirects here. The new route reuses the invitation in this directory to preserve shared component and asset imports.
...
Naming convention: always list the groom first: Anjo & Jasmin, Anjo Villanueva and Jasmin Monteverde, and A & J for initials. Apply this to visible text, metadata, and accessibility labels.
