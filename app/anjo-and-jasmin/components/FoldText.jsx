...
/**
 * @typedef {Object} FoldTextProps
 * @property {string} [text]
 * @property {"char" | "word" | "line"} [splitBy]
 * @property {"top" | "bottom" | "left" | "right"} [hinge]
 * @property {number} [duration]
 * @property {number} [stagger]
 * @property {string} [ease]
 * @property {number} [perspective]
 * @property {number} [creaseShading]
 * @property {"mount" | "hover" | "scroll" | "loop"} [trigger]
