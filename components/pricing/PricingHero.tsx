              ...
              <div className="relative">
                <div className="flex items-start justify-between gap-5">
                  <div>
                    ...
                    <h2 className="mt-3 font-instrumentSerif text-3xl sm:text-4xl">
                ...
                <div className="mt-10 flex items-end justify-between border-b border-white/10 pb-8">
                  <div>
                    ...
                    <p className="mt-1 font-instrumentSerif text-6xl leading-none sm:text-7xl">
                      <span className="mr-1 text-2xl text-champagne-light">
                        ₱
                      </span>
                      799
                    </p>
                  </div>
                  <p className="pb-1 text-right text-xs leading-5 text-white/45">
                    No monthly
                    <br />
                    subscription
                  </p>
